    ...
    <Modal show={show} size='lg' onHide={handleClose}>
      <Form onSubmit={handleSubmit(onSubmit)} onReset={onReset}>
              ...
              <Row>
                <Col md={6} sm={12} className='mb-2 mb-md-0'>
                  <InputGroup>
                    ...
                    <FormControl placeholder='5' aria-label='5' id='retry' name='retry' aria-describedby='retry' ref={register({ pattern: REGEX_NUM })} isInvalid={errors.retry} />
                ...
                <Col md={6} sm={12}>
                  <InputGroup>
                    <InputGroup.Prepend>
                      <InputGroup.Text id='retry-interval'>
        ...
        <Modal.Footer>
          ...
          <Button type='submit' disabled={!isValid || !isDirty} className='ml-3'>
            Save
          </Button>
        </Modal.Footer>
      </Form>
